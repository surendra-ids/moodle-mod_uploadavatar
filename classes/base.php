...
abstract class base {
    ...
    public function get_tags() {
        return implode(', ', \core_tag_tag::get_item_tags_array('mod_uploadavatar', static::$table, $this->id, null, 0, false));
    }
    ...
    public function set_tags($tags = null) {
        ...
        \core_tag_tag::set_item_tags('mod_uploadavatar', static::$table, $this->id, $tagcontext, $list);
    }
    ...
    /**
     * Checks for the assignsubmission_uploadavatar plugin.
     *
     * @static
     * @access public
     * @return bool
     */
    public static function is_assignsubmission_uploadavatar_installed() {
        global $CFG;
        $installed = get_config('assignsubmission_uploadavatar', 'version');
        $path = $CFG->dirroot.'/mod/assign/submission/uploadavatar/locallib.php';
