...
/**
 * The mod_uploadavatar item deleted event class.
 *
...
class item_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted the item with id '$this->objectid' in the Media collection " .
            "with course module id '$this->contextinstanceid'.";
    }

    public static function get_name() {
        return get_string('eventitemdeleted', 'mod_uploadavatar');
    }
