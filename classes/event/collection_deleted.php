...
/**
 * The mod_uploadavatar collection deleted event class.
 *
...
class collection_deleted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'uploadavatar';
    }
    ...
    public static function get_name() {
        return get_string('eventcollectiondeleted', 'mod_uploadavatar');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'uploadavatar', 'delete collection', 'view.php?id=' . $this->contextinstanceid,
