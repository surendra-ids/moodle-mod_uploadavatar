...
/**
 * The mod_uploadavatar gallery deleted event class.
 *
 ...
 */
class gallery_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventgallerydeleted', 'mod_uploadavatar');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'uploadavatar', 'delete gallery', 'view.php?id=' . $this->contextinstanceid,
