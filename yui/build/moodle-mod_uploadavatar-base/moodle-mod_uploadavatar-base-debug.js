YUI.add('moodle-mod_uploadavatar-base', function (Y, NAME) {

M.mod_uploadavatar = M.mod_uploadavatar || {};
M.mod_uploadavatar.base = {
        ...
        this._confirmationListener = this._confirmationListener || node.on('click', function(e) {
            ...
            if (!owner) {
                ...
                confirm.on('complete-yes', function() {
                    ...
                    M.mod_uploadavatar.base.delete_object(itemdata);
                }, this);
            } else {
                var question = M.str.mod_uploadavatar.deleteorremovecollection;
                question += '<br/><input type="textbox" name="deleteorremove"/><br/>';
                question += M.str.mod_uploadavatar.deleteorremovecollectionwarn;
    ...
    watch_delete_thebox: function(type) {
        ...
        var config = {
            title : M.str.mod_uploadavatar['confirm' + type + 'delete'],
            yesLabel : M.str.moodle.submit,
            noLabel : M.str.moodle.cancel,
            closeButtonTitle : M.str.moodle.cancel
        };
        ...
        Y.all(selector + ' .controls .delete').each(function() {
            this._confirmationListener = this._confirmationListener || this.on('click', function(e) {
                ...
                var confirm;
                if (!owner) {
                    config.question = M.str.mod_uploadavatar['remove' + type + 'confirm'];
                    confirm = new M.core.confirm(config);
                    itemdata.action = 'remove';
                    confirm.on('complete-yes', function() {
                        this._confirmationListener.detach();
                        M.mod_uploadavatar.base.delete_object(itemdata, selector);
                    }, this);
                } else {
                    var question = M.str.mod_uploadavatar['deleteorremove' + type];
                    question += '<br/><input type="textbox" name="deleteorremove"/><br/>';
                    question += M.str.mod_uploadavatar['deleteorremove' + type + 'warn'];
                    config.question = '<div class="deleteorremove">' + question + '</div>';
                    confirm = new M.core.confirm(config);
                    confirm.on('complete-yes', function() {
                        itemdata.action = 'remove';
    ...
    watch_editing_buttons : function(type) {
        ...
        var config = {
            title : M.str.mod_uploadavatar["confirm" + type + "delete"],
            origquestion : M.str.mod_uploadavatar["delete" + type] + ' ',
    ...
    watch_mediasize: function() {
        ...
        Y.one(selector).on('change', function(e) {
            ...
            M.util.set_user_preference('mod_uploadavatar_mediasize', size);
        });
    ...
    add_gallery_info_modal : function(courseid, data) {
        ...
        var list = [
            [M.str.mod_uploadavatar.galleryname, data.name],
            [M.str.mod_uploadavatar.creator, userlink]
        ];
        ...
        var config = {
            headerContent : M.str.mod_uploadavatar.information,
    ...
    add_item_info_modal : function(data) {
        ...
        var list = [
            [M.str.mod_uploadavatar.caption, data.caption],
            [M.str.mod_uploadavatar.datecreated, data.timecreatedformatted],
            ...
            [M.str.mod_uploadavatar.moralrights, data.moralrights == "1" ? M.str.moodle.yes : M.str.moodle.no],
            [M.str.mod_uploadavatar.copyright, data.copyrightformatted],
            [M.str.mod_uploadavatar.originalauthor, data.originalauthor],
            [M.str.mod_uploadavatar.productiondate, data.productiondateformatted],
            [M.str.mod_uploadavatar.medium, data.medium],
            [M.str.mod_uploadavatar.publisher, data.publisher],
            [M.str.mod_uploadavatar.broadcaster, data.broadcaster],
            [M.str.mod_uploadavatar.reference, data.reference],
            [M.str.mod_uploadavatar.tags, data.tags]
        ];
    ...
    delete_object : function(data, selector) {
        ...
        Y.io(M.mod_uploadavatar.base.uri, config);
    },
    ...
    lbg_setup : function() {
        ...
        if (this.options.enablelikes) {
            ...
            template += M.str.mod_uploadavatar.like + '</a><span id="lb-likedby"></span>';
        }
        ...
        Y.delegate('click', function(e) {
            ...
            var config = {
                ...
                on: {
                    success : function (id, response) {
                        ...
                        M.mod_uploadavatar.base.update_likes(resp.likes, likedbyme);
                    }
                },
                context: this,
                sync: true
            ...
            Y.io(M.mod_uploadavatar.base.uri, config);
            Y.one('.lb-socialactions a.like').setHTML(icon + M.str.mod_uploadavatar[text]);
    ...
    update_likes : function(likes, likedbyme) {
        ...
        if (likes > 0) {
            str = '&nbsp;&bull;&nbsp;';
            str += M.str.mod_uploadavatar.likedby + ': ';
            if (likedbyme) {
                likes = likes - 1;
                str += M.str.mod_uploadavatar.you + ', ';
            }
            str += likes + ' ';
            if (likes != 1) {
                str += M.str.mod_uploadavatar.others;
            } else {
                str += M.str.mod_uploadavatar.other;
            }
        }
                ...
                success : function (id, response) {
                    ...
                    if (this.options.enablelikes) {
                        ...
                        if (resp.likedbyme) {
                            ...
                            Y.one('.lb-socialactions a.like').setHTML(icon + M.str.mod_uploadavatar.unlike);
                        } else {
                            Y.one('.lb-socialactions a.like').setHTML(icon + M.str.mod_uploadavatar.like);
                        }

                        M.mod_uploadavatar.base.update_likes(resp.likes, resp.likedbyme);
                    }
                    ...
                    if (item.player === "1") {
                        ...
                        str += M.str.mod_uploadavatar.viewfullsize + '</a>';
                    }
        ...
        var config = {
            ...
            on: {
                success : function (id, response) {
                    ...
                    M.mod_uploadavatar.base.load_flowplayer();
                    if (resp.type === 'video') {
    ...
    setup_sample_link : function() {
        var config = {
            title : M.str.mod_uploadavatar.addsamplegallery,
            ...
            Y.one('#mg_sample').on('click', function(e) {
                ...
                var ioconfig = {
                    ...
                    data: {
                        ...
                        m : M.mod_uploadavatar.base.mid,
                        "class" : 'gallery',
                        id : M.mod_uploadavatar.base.gallery,
                    ...
                    on: {
                        success: function(tid, response) {
                            ...
                            var node = Y.Node.create(
                                '<div class="sample_target_wrapper"><span>' + M.str.mod_uploadavatar.uploadavatar + ':</span></div>'
                            );
                ...
                Y.io(M.mod_uploadavatar.base.uri, ioconfig);
    ...
    watch_resize: function() {
        ...
        gallery.on('windowresize', function() {
            ...
            var itemfit = Math.floor(width / M.mod_uploadavatar.base.defaultitemwidth);
...
M.mod_uploadavatar.dragdrop = {
    ...
    init : function() {
        ...
        list.each(function(v) {
            var CSS = M.mod_uploadavatar.dragdrop.CSS;
        ...
        Y.DD.DDM.on('drag:start', function(e) {
            ...
            drag.get('dragNode').addClass('mod_uploadavatar item');
        ...
        Y.DD.DDM.on('drag:end', function(e) {
            ...
            M.mod_uploadavatar.dragdrop.save();
        });
        ...
        Y.DD.DDM.on('drop:over', function(e) {
            ...
            var list = Y.all(M.mod_uploadavatar.dragdrop.CSS.ITEMS);
    ...
    save : function() {
        ...
        Y.io(M.cfg.wwwroot + '/mod/uploadavatar/rest.php', {
            method: 'POST',
